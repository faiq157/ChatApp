...
public class UserOne implements ActionListener, Runnable {
    ...
    UserOne() {
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icons/faiq.png"));
        ...
        ImageIcon i10 = new ImageIcon(ClassLoader.getSystemResource("icons/telephone-call.png"));
        ...
        JLabel name = new JLabel("Faiq Ahmad");
        name.setBounds(110, 15, 100, 18);
        name.setForeground(Color.WHITE);
        name.setFont(new Font("SAN_SERIF", Font.BOLD, 18));
        p1.add(name);
        
        JLabel status = new JLabel("Hassan, Naveed, Saad, Asif, Maaz, Mussa");
