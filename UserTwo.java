...
public class UserTwo implements ActionListener, Runnable {
    ...
    UserTwo() {
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icons/hassan.png"));
        ...
        JLabel status = new JLabel("FaiqAhmad, Naveed, Saad, Mussa");
